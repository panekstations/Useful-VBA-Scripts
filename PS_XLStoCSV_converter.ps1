$SourceFolder = "M:\assocfin\Rebates\CLIENTS\Iberics\Allfunds International\Holding Statements\2020\Q1" # Does not require final \
$DestinationFolder = "M:\assocfin\Rebates\CLIENTS\Iberics\Allfunds International\Holding Statements\2020\Q1" # Must include final \
